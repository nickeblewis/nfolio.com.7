<template>
  <Layout>
    ...
    <div class="container-inner mx-auto">
      ...
      >The web is a large and bewildering place, our business can help you get your ideas off the ground. We are here to help steer your ideas and deliver them online.</p>

      <p
        class="text-lg sm:text-xl"
      >Content and data is the lifeblood of any successful business and with a broad range of experience across photography, content development (CMS) and Javascript coding, we can make that happen for you.</p>
      ...
      >
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            ...
            >Content Management Systems need not be daunting and that is why we work with lightweight, easy to learn, simple to use systems that can help us collaborate. Take for example Netlify CMS and I am also a Javascript Developer, highly experienced with frameworks such as Vue and React.</div>
          </li>
          <li class="checkmark mb-6">
            <div>Content Writing</div>
            <div
              class="text-lg text-gray-600"
            >My Wife and I both enjoy writing, so a lot of the writing Tina takes care of and she can help you put together great content for your website or other projects</div>
          </li>
          <li class="checkmark mb-6">
            <div>Photography</div>
          ...
          <li class="checkmark mb-6">
            ...
            <div
              class="text-lg text-gray-600"
            >Social media has it's challenges but alongside traditional websites, is a critical part of any business's connection with it's audience. Naturally writing, photography and video skills come into play</div>
          </li>
        </ul>
      </div>
      <!-- end projects -->
      ...
      >
        ...
        <ul class="text-lg sm:text-xl">
          ...
          <li class="checkmark mb-6">
            ...
            <div
              class="text-lg text-gray-600"
            >Well - fill out the contact form today for a quotation and quick response from us!</div>
          </li>
        </ul>
      </div>
      <!-- end projects -->
