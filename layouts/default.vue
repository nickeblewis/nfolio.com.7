    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a href="https://youtube.com/nicklewis" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/nickeblewis" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/nicklewis" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/nicklewisphotography" target="_blank" class="text-white hover:text-gray-400">
