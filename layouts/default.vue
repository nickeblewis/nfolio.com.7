<template>
  <div
    class="content-wrapper bg-background-secondary font-sans text-copy-primary leading-normal flex flex-col min-h-screen"
    :class="theme"
  >
    <header class="bg-background-tertiary">
      <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
        ...
        <button v-on:click="fetchData" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
  Refresh
</button>
